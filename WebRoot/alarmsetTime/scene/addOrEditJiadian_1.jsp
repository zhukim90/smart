...
.jiange1{height:3em;width: 37%;text-align: right;font-size: 2em;line-height: 5em;color:white;}
.jiange2{height:3em;width: 35%;text-align: right;font-size: 2em;line-height: 5em;color:white;}
...
function wordChange(){
   ...
   //小时：document.getElementById("timexiaoshi")
   ...
   //分钟：document.getElementById("timefenzhong")
