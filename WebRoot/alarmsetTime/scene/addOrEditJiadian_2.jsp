...
<div class="timePop" id="timePop" >
    ...
    <div class="timeAll u-b-radius">
        ...
        <div class="timeText textAlign2">起始时间</div>	
    ...
    <!--时间控件---E1-->  
    <div class="jiangeTimeToTime"></div><!-- 自动布防时间横线间隔 -->
    <!--时间控件---S2--> 
    <div class="timeAll2 u-b-radius">
		<div class="jiange">
		 <div class="jiange1 float1">时</div>
		 <div class="jiange2 float1">分</div>
		</div>

        <div class="timeText textAlign2">结束时间</div>	
 
        <div class="timeDiv">
         
            
            <!--小时的最外侧div，高度固定不动-->
            <div class="timexiaoshi float1" id="timexiaoshi2">
            	<!--里层包含小时的div，这个div高度是自动的-->
            	<div class="timexiaoshiSub" id="timexiaoshiSub2">
            ...
            <div class="timefenzhong float1" id="timefenzhong2"><!--分钟div-->
            	<div class="timefenzhongSub" id="timefenzhongSub2">
...
.timeAll2{ width:100%; color:#9a9a9a; height:35.5em; position:absolute; position:relative; left:0%; top:21%; background:#fff;   overflow:hidden;}
.jiangeTimeToTime{width:100%;height:1em;top:16%;border-top:0.2em solid #e8e8e8;}
...
.jiange{ height:6em; width:100%; border-bottom: 1px solid #e8e8e8; border-top: 1px solid #e8e8e8; position:absolute; top:18em; left:0;background-color:#007799;}
...
window.onload = function(){
	...
	touchFuncTime(document.getElementById("timexiaoshi2"), document.getElementById("timexiaoshiSub2"), "", "", true);
	touchFuncTime(document.getElementById("timefenzhong2"), document.getElementById("timefenzhongSub2"), "", "", true);
}
...
function initMinDiv(){//初始化分钟控件
	...
	document.getElementById("timefenzhongSub2").innerHTML = minuteHtml+minuteHtml+minuteHtml;
		...
		if(isScroll){
			...
			if(changeY<0){//div往上滚动,scrollTop变大
				if((moveObj.offsetHeight-obj.offsetHeight-obj.scrollTop)<averageTimeHeight*5){
					...
					if(obj == document.getElementById("timexiaoshi") || obj == document.getElementById("timexiaoshi2")){
...
function wordChange(){
   var curTopNumHour=0;
   var curTopNumMinute=0;
   //小时1：document.getElementById("timexiaoshi")
   if(document.getElementById("timexiaoshi").scrollTop>22*averageTimeHeight){
		curTopNumHour = Math.round(document.getElementById("timexiaoshi").scrollTop%(24*averageTimeHeight)/averageTimeHeight)+2;
	}else{
		curTopNumHour = Math.round(document.getElementById("timexiaoshi").scrollTop/averageTimeHeight)+2;
	}
	var tempHourObj = $(document.getElementById("timexiaoshiSub")).children().eq(curTopNumHour)
	
	tempHourObj.css({'color':'white','height':'96px','font-size':'96px','line-height':'96px'});
	tempHourObj.prev().prev().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	tempHourObj.prev().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempHourObj.next().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempHourObj.next().next().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	
	//小时2：document.getElementById("timexiaoshi")
   if(document.getElementById("timexiaoshi2").scrollTop>22*averageTimeHeight){
		curTopNumHour2 = Math.round(document.getElementById("timexiaoshi2").scrollTop%(24*averageTimeHeight)/averageTimeHeight)+2;
	}else{
		curTopNumHour2 = Math.round(document.getElementById("timexiaoshi2").scrollTop/averageTimeHeight)+2;
	}
	var tempHourObj2 = $(document.getElementById("timexiaoshiSub2")).children().eq(curTopNumHour2)
	
	tempHourObj2.css({'color':'white','height':'96px','font-size':'96px','line-height':'96px'});
	tempHourObj2.prev().prev().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	tempHourObj2.prev().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempHourObj2.next().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempHourObj2.next().next().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	
   //分钟1：document.getElementById("timefenzhong")
   if(document.getElementById("timefenzhong").scrollTop>58*averageTimeHeight){
		curTopNumMinute = Math.round(document.getElementById("timefenzhong").scrollTop%(60*averageTimeHeight)/averageTimeHeight)+2;
	}else{
		curTopNumMinute = Math.round(document.getElementById("timefenzhong").scrollTop/averageTimeHeight)+2;
	}
    var tempMinuteObj = $(document.getElementById("timefenzhongSub")).children().eq(curTopNumMinute);
    
	tempMinuteObj.css({'color':'white','height':'96px','font-size':'96px','line-height':'96px'});
	tempMinuteObj.prev().prev().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	tempMinuteObj.prev().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempMinuteObj.next().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempMinuteObj.next().next().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	
	 //分钟2：document.getElementById("timefenzhong")
   if(document.getElementById("timefenzhong2").scrollTop>58*averageTimeHeight){
		curTopNumMinute2 = Math.round(document.getElementById("timefenzhong2").scrollTop%(60*averageTimeHeight)/averageTimeHeight)+2;
	}else{
		curTopNumMinute2 = Math.round(document.getElementById("timefenzhong2").scrollTop/averageTimeHeight)+2;
	}
    var tempMinuteObj2 = $(document.getElementById("timefenzhongSub2")).children().eq(curTopNumMinute2);
    
	tempMinuteObj2.css({'color':'white','height':'96px','font-size':'96px','line-height':'96px'});
	tempMinuteObj2.prev().prev().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	tempMinuteObj2.prev().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempMinuteObj2.next().css({'color':'#444444','height':'96px','font-size':'50px','line-height':'96px'});
	tempMinuteObj2.next().next().css({'color':'#AAAAAA','height':'96px','font-size':'30px','line-height':'96px'});
	
	//清楚检测
	clearInterval(intervalTime);
	intervalTime=setInterval("wordChange()",5);
}
var intervalTime=setInterval("wordChange()",5);
