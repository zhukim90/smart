...
<div class="yonghu">
 ...
 <!-- 提示框 -->
	<div id="tipsDiv" style="display: none;position: fixed;top: 0;z-index: 999;width: 100%;height: 100%;background: rgba(8, 8, 8, 0.7);">
	...
	<!-- 提示框 -->
	<div id="yesDiv" style="display: none;position: fixed;top: 0;z-index: 999;width: 100%;height: 100%;background: rgba(8, 8, 8, 0.7);">
