...
public class SysConfigurationRead {
    ...
    private static String PFILE = "config/properties/sysconfig.properties";
    ...
    private static SysConfigurationRead m_instance = new SysConfigurationRead();
    ...
    public synchronized static SysConfigurationRead getInstance() {
